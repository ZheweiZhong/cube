...
const TableComponent = props => {
  ...
  const tableHeaders = [
    { text: "status1", value: "ChargingStations.status1" },
    { text: "status2", value: "ChargingStations.status2" },
    { text: "organisation", value: 'ChargingStations.organisation' },
              ...
              <Table>
                ...
                <TableBody>
                  {orders.slice(page * rowsPerPage, page * rowsPerPage + rowsPerPage).map(obj => (
                    ...
                    >
                      <TableCell>
                        {obj['ChargingStations.status1']}
                      </TableCell>
                      <TableCell>
                        {obj['ChargingStations.status2']}
                      </TableCell>
                      <TableCell>
                        {obj['ChargingStations.organisation']}
                      </TableCell>
                    </TableRow>
                  ))}
                </TableBody>
